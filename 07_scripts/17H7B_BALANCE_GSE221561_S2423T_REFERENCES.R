...
# STEP 17H7B
#
# Balance GSE221561 S2423T references to 500+500 cells
#
...
cat("\n============================================================\n")
cat("STEP 17H7B: BALANCE GSE221561 S2423T REFERENCES\n")
cat("============================================================\n\n")
...
pilot_dir <- "06_tables/cross_dataset/malignant_epithelial/GSE221561_S2423T_pilot"
...
saveRDS(cpm_balanced, file.path(pilot_dir, "GSE221561_S2423T_BALANCED_infercna_CPM_hg38.rds"), compress = FALSE)
saveRDS(refCells_balanced, file.path(pilot_dir, "GSE221561_S2423T_BALANCED_infercna_refCells.rds"))

fwrite(ann, file.path(pilot_dir, "GSE221561_S2423T_BALANCED_infercna_cell_annotation.csv"), bom = TRUE)
fwrite(gene_table_balanced, file.path(pilot_dir, "GSE221561_S2423T_BALANCED_infercna_gene_table.csv"), bom = TRUE)
...
fwrite(manifest, file.path(pilot_dir, "GSE221561_S2423T_BALANCED_infercna_manifest.csv"), bom = TRUE)
...
check <- readRDS(file.path(pilot_dir, "GSE221561_S2423T_BALANCED_infercna_CPM_hg38.rds"))
check_refs <- readRDS(file.path(pilot_dir, "GSE221561_S2423T_BALANCED_infercna_refCells.rds"))
...
cat("\n============================================================\n")
cat("STEP 17H7B FINISHED\n")
cat("GSE221561 S2423T BALANCED INPUTS READY\n")
cat("============================================================\n\n")
