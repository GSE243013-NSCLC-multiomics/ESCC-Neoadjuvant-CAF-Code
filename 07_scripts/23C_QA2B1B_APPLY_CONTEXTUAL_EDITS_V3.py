...
print()
print("=" * 92)
print("STEP23C-QA2B1B V3: APPLY CONTEXTUAL LOCKED EDITS")
print("=" * 92)
print()
...
EDITS = [
    ...
    # --------------------------------------------------------
    {
        ...
        "new":
            "Within the two discovery cohorts, the fibroblast CORE2 response "
            "was the most stable treatment-associated result of this",
    },
...
print()
print("=" * 92)
print("STEP23C-QA2B1B V3 COMPLETE")
print("=" * 92)
print()
