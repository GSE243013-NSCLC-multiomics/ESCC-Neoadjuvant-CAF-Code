...
# STEP 17H5A
#
# Prepare GSE221561 S9478T InferCNA pilot inputs.
#
# Strategy:
#   - S9478T tumor epithelial (Surgery_alone, ~312 cells)
...
cat("\n============================================================\n")
cat("STEP 17H5A: PREPARE GSE221561 S9478T INFERCNA PILOT\n")
cat("============================================================\n\n")
...
if (length(pilot_cells) < 30) {
  stop("S9478T epithelial tumor cells < 30. STOPPING.")
}
...
raw_file <- file.path(pilot_dir, "GSE221561_S9478T_infercna_raw_counts_hg38.rds")
...
cpm_file <- file.path(pilot_dir, "GSE221561_S9478T_infercna_CPM_hg38.rds")
refs_file <- file.path(pilot_dir, "GSE221561_S9478T_infercna_refCells.rds")
annotation_file <- file.path(pilot_dir, "GSE221561_S9478T_infercna_cell_annotation.csv")
genes_file <- file.path(pilot_dir, "GSE221561_S9478T_infercna_gene_table.csv")
manifest_file <- file.path(pilot_dir, "GSE221561_S9478T_infercna_manifest.csv")
...
manifest <- data.table(
  ...
  selection_rule = "Surgery_alone epithelial sample (independent second pilot)",
...
cat("\n============================================================\n")
cat("STEP 17H5A FINISHED\n")
cat("GSE221561 S9478T PILOT INPUT READY\n")
cat("============================================================\n\n")
