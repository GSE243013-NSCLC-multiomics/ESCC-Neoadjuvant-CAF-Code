...
# STEP 17H5C
#
# Run InferCNA on BALANCED GSE221561 S9478T pilot
#
# Tumor:  S9478T epithelial cells = 312
...
cat("\n============================================================\n")
cat("STEP 17H5C: GSE221561 S9478T INFERCNA PILOT\n")
cat("============================================================\n\n")
...
indir <- "06_tables/cross_dataset/malignant_epithelial/GSE221561_S9478T_pilot"

outdir <- file.path(indir, "17H5C_results")

figdir <- "05_figures/GSE221561/malignant_epithelial/S9478T_pilot"
...
cat("===== 1. LOCATE BALANCED 17H5B INPUTS =====\n\n")
...
print(params)
fwrite(params, file.path(outdir, "GSE221561_S9478T_17H5C_parameters.csv"), bom = TRUE)
...
cat("\n============================================================\n")
cat("8. RUNNING INFERCNA — S9478T PILOT\n")
cat("============================================================\n\n")

cat("This is the third GSE221561 CNV run.\n")
...
cna <- tryCatch(
  ...
  error = function(e) {
    ...
    stop("Step 17H5C stopped during InferCNA.")
  }
)
...
all_cna_file <- file.path(outdir, "GSE221561_S9478T_infercna_CNA_all_cells.rds")
tumor_cna_file <- file.path(outdir, "GSE221561_S9478T_infercna_CNA_tumor_only.rds")
...
cat("\n============================================================\n")
cat("13. S9478T TUMOR VS NORMAL SUMMARY\n")
cat("============================================================\n\n")
...
fwrite(summary_dt, file.path(outdir, "GSE221561_S9478T_17H5C_tumor_normal_summary.csv"), bom = TRUE)
fwrite(cell_metrics, file.path(outdir, "GSE221561_S9478T_17H5C_cell_CNA_metrics.csv"), bom = TRUE)
...
fwrite(sample_summary, file.path(outdir, "GSE221561_S9478T_17H5C_sample_QC.csv"), bom = TRUE)
...
fwrite(arm_dt, file.path(outdir, "GSE221561_S9478T_17H5C_all_arm_metrics.csv"), bom = TRUE)
fwrite(coherent, file.path(outdir, "GSE221561_S9478T_17H5C_candidate_coherent_arms.csv"), bom = TRUE)
...
heat_png <- file.path(figdir, "GSE221561_S9478T_InferCNA_manual_all_cells_heatmap.png")
...
image(x = seq_len(ncol(z)), y = seq_len(nrow(z)), z = t(z), axes = FALSE, xlab = "Chromosome", ylab = "Cells", main = "GSE221561 S9478T InferCNA Pilot", col = hcl.colors(101, "Blue-Red 3"))
...
cell_group[cell_order %in% tumor_cells] <- "S9478T"
...
tumor_png <- file.path(figdir, "GSE221561_S9478T_InferCNA_manual_tumor_only_heatmap.png")
...
image(x = seq_len(ncol(zt)), y = seq_len(nrow(zt)), z = t(zt), axes = FALSE, xlab = "Chromosome", ylab = "S9478T Tumor Epithelial Cells", main = "S9478T Tumor Epithelial CNA Profiles", col = hcl.colors(101, "Blue-Red 3"))
...
scatter_png <- file.path(figdir, "GSE221561_S9478T_CNA_signal_vs_cnaCor_scatter.png")
...
plot(
  ...
  main = "S9478T: CNA Signal vs cnaCor",
...
legend(
  "topleft",
  legend = c("Normal references", "Tumor (S9478T)"),
  col = c("grey50", "red"),
  pch = 16,
  bty = "n",
  cex = 0.9
...
cat("\n============================================================\n")
cat("18. GSE221561 S9478T PILOT REVIEW GATE\n")
cat("============================================================\n\n")
...
cat(sprintf("S9478T tumor median CNA signal        : %.5f\n", tumor_signal_med))
...
fwrite(manifest, file.path(outdir, "GSE221561_S9478T_17H5C_manifest.csv"), bom = TRUE)
...
cat("\n============================================================\n")
cat("STEP 17H5C FINISHED\n")
cat("GSE221561 S9478T INFERCNA PILOT COMPLETE\n")
cat("============================================================\n\n")

cat("============================================\n")
cat("STEP 17H5 COMPLETE\n")
cat("GSE221561 S9478T SECOND SURGERY-ALONE PILOT\n")
cat("============================================\n\n")
