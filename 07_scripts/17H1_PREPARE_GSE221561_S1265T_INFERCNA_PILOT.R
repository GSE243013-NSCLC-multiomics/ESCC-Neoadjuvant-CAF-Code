...
# STEP 17H1
#
# Prepare GSE221561 S1265T InferCNA pilot inputs.
#
# Strategy:
#   - S1265T tumor epithelial (Neoadjuvant_treated, 4972 cells)
...
#   - Same InferCNA parameters as GSE197677 and S6417T
#
# IMPORTANT:
#   NO InferCNA run
#   NO JoinLayers
...
cat("\n============================================================\n")
cat("STEP 17H1: PREPARE GSE221561 S1265T INFERCNA PILOT\n")
cat("============================================================\n\n")
...
raw_file <- file.path(pilot_dir, "GSE221561_S1265T_infercna_raw_counts_hg38.rds")
...
cpm_file <- file.path(pilot_dir, "GSE221561_S1265T_infercna_CPM_hg38.rds")
refs_file <- file.path(pilot_dir, "GSE221561_S1265T_infercna_refCells.rds")
annotation_file <- file.path(pilot_dir, "GSE221561_S1265T_infercna_cell_annotation.csv")
genes_file <- file.path(pilot_dir, "GSE221561_S1265T_infercna_gene_table.csv")
manifest_file <- file.path(pilot_dir, "GSE221561_S1265T_infercna_manifest.csv")
...
manifest <- data.table(
  ...
  selection_rule = "largest Neoadjuvant_treated epithelial sample",
...
cat("\n============================================================\n")
cat("STEP 17H1 FINISHED\n")
cat("GSE221561 S1265T PILOT INPUT READY\n")
cat("============================================================\n\n")
...
cat("\nSAME PARAMETERS AS GSE197677 AND S6417T:\n")
cat("  window = 100\n")
cat("  n = 5000\n")
cat("  noise = 0.1\n")
