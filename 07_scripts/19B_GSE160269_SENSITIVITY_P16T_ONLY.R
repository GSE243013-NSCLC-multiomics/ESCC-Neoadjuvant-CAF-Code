#!/usr/bin/env Rscript
# ==============================================================================
# 19B: GSE160269 REFERENCE SENSITIVITY - P16T ONLY
# ==============================================================================
...
# Load prepared data
base_dir <- "06_tables/cross_dataset/malignant_epithelial/GSE160269_P16T_pilot"
cpm_combined <- readRDS(file.path(base_dir, "GSE160269_P16T_infercna_CPM_hg38.rds"))
annot <- fread(file.path(base_dir, "GSE160269_P16T_infercna_cell_annotation.csv"))
gene_table <- fread(file.path(base_dir, "GSE160269_P16T_infercna_gene_table.csv"))
...
cat("P16T tumor cells:", length(tumor_cells), "\n")
cat("Normal cells:\n")
...
results_dt$tumor_id <- "P16T"

fwrite(results_dt, file.path(OUTDIR, "P16T_sensitivity_metrics.csv"))

cat("\n\n============================================================\n")
cat("P16T SENSITIVITY RESULTS\n")
cat("============================================================\n\n")
...
cat("\nSaved: P16T_sensitivity_metrics.csv\n")
