...
# STEP 17H2
#
# Balance GSE221561 S1265T references to 500+500 cells
#
# Same strategy as 17G2B for S6417T:
#   - S6417N: 500 cells (seed = 12651817)
#   - S9478N: 500 cells (seed = 12651818)
...
cat("\n============================================================\n")
cat("STEP 17H2: BALANCE GSE221561 S1265T REFERENCES\n")
cat("============================================================\n\n")
...
pilot_dir <- "06_tables/cross_dataset/malignant_epithelial/GSE221561_S1265T_pilot"
...
saveRDS(cpm_balanced, file.path(pilot_dir, "GSE221561_S1265T_BALANCED_infercna_CPM_hg38.rds"), compress = FALSE)
saveRDS(refCells_balanced, file.path(pilot_dir, "GSE221561_S1265T_BALANCED_infercna_refCells.rds"))

fwrite(ann, file.path(pilot_dir, "GSE221561_S1265T_BALANCED_infercna_cell_annotation.csv"), bom = TRUE)
fwrite(gene_table_balanced, file.path(pilot_dir, "GSE221561_S1265T_BALANCED_infercna_gene_table.csv"), bom = TRUE)
...
fwrite(manifest, file.path(pilot_dir, "GSE221561_S1265T_BALANCED_infercna_manifest.csv"), bom = TRUE)
...
check <- readRDS(file.path(pilot_dir, "GSE221561_S1265T_BALANCED_infercna_CPM_hg38.rds"))
check_refs <- readRDS(file.path(pilot_dir, "GSE221561_S1265T_BALANCED_infercna_refCells.rds"))
...
cat("\n============================================================\n")
cat("STEP 17H2 FINISHED\n")
cat("GSE221561 S1265T BALANCED INPUTS READY\n")
cat("============================================================\n\n")

cat("Tumor cells       : ", length(tumor_cells), "\n", sep = "")
cat("S6417N balanced   : ", length(s6417n_balanced), "\n", sep = "")
cat("S9478N balanced   : ", length(s9478n_balanced), "\n", sep = "")
cat("Total cells       : ", ncol(cpm_balanced), "\n", sep = "")
cat("Final hg38 genes  : ", nrow(cpm_balanced), "\n", sep = "")
