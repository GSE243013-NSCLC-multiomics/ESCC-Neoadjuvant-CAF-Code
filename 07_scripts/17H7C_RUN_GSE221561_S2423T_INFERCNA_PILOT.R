...
# STEP 17H7C
#
# Run InferCNA on BALANCED GSE221561 S2423T pilot
#
# Tumor:  S2423T epithelial cells = 4363
...
cat("\n============================================================\n")
cat("STEP 17H7C: GSE221561 S2423T INFERCNA PILOT\n")
cat("============================================================\n\n")
...
indir <- "06_tables/cross_dataset/malignant_epithelial/GSE221561_S2423T_pilot"

outdir <- file.path(indir, "17H7C_results")

figdir <- "05_figures/GSE221561/malignant_epithelial/S2423T_pilot"
...
cat("===== 1. LOCATE BALANCED 17H7B INPUTS =====\n\n")
...
print(params)
fwrite(params, file.path(outdir, "GSE221561_S2423T_17H7C_parameters.csv"), bom = TRUE)
...
cat("\n============================================================\n")
cat("8. RUNNING INFERCNA — S2423T PILOT\n")
cat("============================================================\n\n")

cat("This is the fourth GSE221561 CNV run.\n")
...
cna <- tryCatch(
  ...
  error = function(e) {
    ...
    stop("Step 17H7C stopped during InferCNA.")
  }
)
...
all_cna_file <- file.path(outdir, "GSE221561_S2423T_infercna_CNA_all_cells.rds")
tumor_cna_file <- file.path(outdir, "GSE221561_S2423T_infercna_CNA_tumor_only.rds")
...
cat("\n============================================================\n")
cat("13. S2423T TUMOR VS NORMAL SUMMARY\n")
cat("============================================================\n\n")
...
fwrite(summary_dt, file.path(outdir, "GSE221561_S2423T_17H7C_tumor_normal_summary.csv"), bom = TRUE)
fwrite(cell_metrics, file.path(outdir, "GSE221561_S2423T_17H7C_cell_CNA_metrics.csv"), bom = TRUE)
...
fwrite(sample_summary, file.path(outdir, "GSE221561_S2423T_17H7C_sample_QC.csv"), bom = TRUE)
...
fwrite(arm_dt, file.path(outdir, "GSE221561_S2423T_17H7C_all_arm_metrics.csv"), bom = TRUE)
fwrite(coherent, file.path(outdir, "GSE221561_S2423T_17H7C_candidate_coherent_arms.csv"), bom = TRUE)
...
heat_png <- file.path(figdir, "GSE221561_S2423T_InferCNA_manual_all_cells_heatmap.png")
...
image(x = seq_len(ncol(z)), y = seq_len(nrow(z)), z = t(z), axes = FALSE, xlab = "Chromosome", ylab = "Cells", main = "GSE221561 S2423T InferCNA Pilot", col = hcl.colors(101, "Blue-Red 3"))
...
cell_group[cell_order %in% tumor_cells] <- "S2423T"
...
tumor_png <- file.path(figdir, "GSE221561_S2423T_InferCNA_manual_tumor_only_heatmap.png")
...
image(x = seq_len(ncol(zt)), y = seq_len(nrow(zt)), z = t(zt), axes = FALSE, xlab = "Chromosome", ylab = "S2423T Tumor Epithelial Cells", main = "S2423T Tumor Epithelial CNA Profiles", col = hcl.colors(101, "Blue-Red 3"))
...
scatter_png <- file.path(figdir, "GSE221561_S2423T_CNA_signal_vs_cnaCor_scatter.png")
...
plot(
  ...
  main = "S2423T: CNA Signal vs cnaCor",
...
legend(
  "topleft",
  legend = c("Normal references", "Tumor (S2423T)"),
  col = c("grey50", "red"),
  pch = 16,
  bty = "n",
  cex = 0.9
...
cat("\n============================================================\n")
cat("18. GSE221561 S2423T PILOT REVIEW GATE\n")
cat("============================================================\n\n")
...
cat(sprintf("S2423T tumor median CNA signal        : %.5f\n", tumor_signal_med))
...
fwrite(manifest, file.path(outdir, "GSE221561_S2423T_17H7C_manifest.csv"), bom = TRUE)
...
cat("\n============================================================\n")
cat("STEP 17H7C FINISHED\n")
cat("GSE221561 S2423T INFERCNA PILOT COMPLETE\n")
cat("============================================================\n\n")
