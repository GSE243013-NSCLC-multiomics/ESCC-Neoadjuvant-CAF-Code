...
# STEP 17H7A
#
# Prepare GSE221561 S2423T InferCNA pilot inputs.
#
# Strategy (copied from successful S1265T 17H1):
#   - S2423T tumor epithelial (Neoadjuvant_treated, ~4363 cells)
#   - S6417N + S9478N normal epithelial references
#   - Extract from split layers WITHOUT JoinLayers
#   - Resolve duplicate hg38 target symbols
...
cat("\n============================================================\n")
cat("STEP 17H7A: PREPARE GSE221561 S2423T INFERCNA PILOT\n")
cat("============================================================\n\n")
...
if (length(pilot_cells) < 30) {
  stop("S2423T epithelial tumor cells < 30. STOPPING.")
}
...
cat("Pilot treatment    : Neoadjuvant_treated\n", sep = "")
...
raw_file <- file.path(pilot_dir, "GSE221561_S2423T_infercna_raw_counts_hg38.rds")
...
cpm_file <- file.path(pilot_dir, "GSE221561_S2423T_infercna_CPM_hg38.rds")
refs_file <- file.path(pilot_dir, "GSE221561_S2423T_infercna_refCells.rds")
annotation_file <- file.path(pilot_dir, "GSE221561_S2423T_infercna_cell_annotation.csv")
genes_file <- file.path(pilot_dir, "GSE221561_S2423T_infercna_gene_table.csv")
manifest_file <- file.path(pilot_dir, "GSE221561_S2423T_infercna_manifest.csv")
...
manifest <- data.table(
  ...
  selection_rule = "Neoadjuvant_treated epithelial sample (second treated pilot)",
...
cat("\n============================================================\n")
cat("STEP 17H7A FINISHED\n")
cat("GSE221561 S2423T PILOT INPUT READY\n")
cat("============================================================\n\n")
